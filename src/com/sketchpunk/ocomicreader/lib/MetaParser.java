		    ...
		    while(eventType != XmlPullParser.END_DOCUMENT && !isDone){
		        switch (eventType){
		            ...
		            case XmlPullParser.START_TAG:
		            	...
		            	if(nodename.equalsIgnoreCase("Title")){			rtn[0] = parser.nextText(); itmCnt++; }
		            	else if(nodename.equalsIgnoreCase("Series")){	rtn[1] = parser.nextText(); itmCnt++; }
		            	else if(nodename.equalsIgnoreCase("Volume")){	rtn[2] = parser.nextText(); itmCnt++; }
		            	else if(nodename.equalsIgnoreCase("Number")){	rtn[3] = parser.nextText(); itmCnt++; }
