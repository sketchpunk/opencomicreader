...
public class ComicPageView extends View implements
	...
	private void init(Context context) {
		...
		// make scaled image less pixelated
	...
	private void resetScale() {
		...
		case ComicPageView.ScaleToHeight:
			mImgSize.scale = (float) mViewSize.oHeight / mImgSize.oHeight;
			break;
		case ComicPageView.ScaleToWidth:
			mImgSize.scale = (float) mViewSize.oWidth / mImgSize.oWidth;
			break;
		case ComicPageView.ScaleNone:
			mImgSize.scale = 1f;
			break;
		case ComicPageView.ScaleAuto:
			mImgSize.scale = Math.min(
					((float) mViewSize.oWidth / mImgSize.oWidth),
					((float) mViewSize.oHeight / mImgSize.oHeight));
			break;
		}
	...
	@Override
	// needed to return true to get most of the gestures to work.
	...
	public boolean onScale(ScaleGestureDetector dScale) {
		...
		// Calc new matrix scale to test what the height will become.
		float newScale = prevScale * ratio;
